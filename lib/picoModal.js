!function (a, b) {
    ...
    function c() {
        var a = [];
        return {
            watch: a.push.bind(a), trigger: function (b, c) {
                for (var d = !0, e = {
                    detail: c, preventDefault: function () {
                        d = !1
                    }
    ...
    function f(a, b) {
        return e.make(a("parent")).clazz("pico-overlay").clazz(a("overlayClass", "")).stylize({
            ...
            width: "100%",
            zIndex: 1e4
        }).stylize(a("overlayStyles", {opacity: .5, background: "#000"})).onClick(function () {
            a("overlayClose", !0) && b()
        })
    }
    ...
    function j(a, b) {
        ...
        function f(a) {
            for (var b = a.getElementsByTagName("*"), c = 0; c < b.length; c++) if (e(b[c])) return b[c]
        }

        function g(a) {
            for (var b = a.getElementsByTagName("*"), c = b.length; c--;) if (e(b[c])) return b[c]
        }
        ...
        a.beforeShow(function () {
            ...
            if (b() && a.isVisible()) {
                var d = f(a.modalElem()), e = g(a.modalElem()), h = c.shiftKey ? d : e;
    ...
    function k(a, b) {
        ...
        a.beforeShow(function () {
            c = d.elem.style.overflow, b() && d.stylize({overflow: "hidden"})
        }), a.afterClose(function () {
            d.stylize({overflow: c})
        })
    }
    ...
    return document.documentElement.addEventListener("keydown", function (a) {
        ...
        function p(a, b) {
            if (!r) {
                var c = g(e, n);
                r = {modal: c, overlay: f(e, n), close: h(c, e)}, s.trigger(q, b)
            }
            return r[a]
        }

        (b(d) || a(d)) && (d = {content: d});
        var q, r, s = c(), t = c(), u = c(), v = c(), w = c(), x = p.bind(window, "modal"),
            y = p.bind(window, "overlay"), z = p.bind(window, "close");
        return q = {
            modalElem: i(x),
            closeElem: i(z),
            overlayElem: i(y),
